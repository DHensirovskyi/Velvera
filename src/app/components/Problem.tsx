        ...
        <section className="flex items-center justify-center flex-col gap-[68px] text-center mb-[90px]">
            <div className="flex flex-col justify-center items-center gap-[18px]">
                <div className="flex gap-2.5 w-[87px] items-center">
                    ...
                    <p className="text-[1rem] text-black font-[400]">Problem</p>
                </div>
                <h1 className="max-w-[615px] sm:text-[3.125rem]/[130%] text-[2.5rem]/[118%] font-semibold">
                    Häufige Haarprobleme, die auftreten können
                </h1>
            </div>
            <div className="w-auto xl:w-[1150px]" ref={ref}>
                ...
                <div key={i.name} className="flex flex-col items-center text-center gap-[34px] w-full">
                    <span className="flex items-center justify-center w-[56px] h-[56px] rounded-full bg-[#FFF9F5]">
                    <Image
                        src={i.img}
                        alt={i.name}
                        width={28}
