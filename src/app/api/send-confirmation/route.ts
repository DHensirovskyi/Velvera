...
function htmlTemplate({
  name, service, dateHuman, time, cancelUrl,
}: { name: string; service: string; dateHuman: string; time: string; cancelUrl: string; }) {
  const subject = 'Terminbestätigung';
  const preheader = `Termin ${dateHuman} ${time} bestätigt. Falls nötig, hier stornieren.`;
